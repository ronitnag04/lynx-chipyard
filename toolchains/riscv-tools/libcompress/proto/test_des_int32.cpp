// The compile option is like below for procuding riscv file. 
...
int main() {
  ...
  ROCC_INSTRUCTION_I_R_R(PROTOACC_OPCODE, 0, fixed_ptr_as_int, array_ptr_as_int, FUNCT_MEM_SETUP+DES_EXTEND);
