...
int main(void) {
  ...
  std::string device = "iceblk,img=/scratch/abejgonza/work/hy-07092024-again/software/firemarshal/images/firechip/encrypt-measure-checkpoint/encrypt-measure-checkpoint.img";
